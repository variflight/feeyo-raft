...
public abstract class AbstractSnapshotter {
	...
	//
	public abstract void gc();	// Snapshot GC for destroy expired garbage files
	public abstract SnapshotMetadata getMetadata(); // Metadata of the latest snapshot
	public abstract Writeable create(boolean isItRemote); // Create a snapshot writer
	public abstract Readable open(boolean isItRemote, long index, long term); // Open a snapshot reader.
	public abstract void moveFile(Readable readable); // Move remote to local
