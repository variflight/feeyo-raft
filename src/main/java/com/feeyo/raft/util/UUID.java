...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
	...
	// @see java.util.UUID
	// fix new byte[16] & toString
	//
	private static ThreadLocal<byte[]> randomBytesGen = new ThreadLocal<byte[]>() {
    ...
    public static UUID randomUUID() {
        ...
        // reset
        byte[] randomBytes = randomBytesGen.get();
        for(int i = 0; i < randomBytes.length; i++) 
        	randomBytes[i] = (byte)0;
        //
    ...
    public String toString() {
    	...
    	sb.append( digits(mostSigBits >> 16, 4)  ).append("-");
    	sb.append( digits(mostSigBits, 4) ).append("-");
    	sb.append( digits(leastSigBits >> 48, 4) ).append("-");
